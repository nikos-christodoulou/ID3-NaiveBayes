...
if(type_of_test == "test_examples"):
    ...
    for x in range(0,len(predict_data_reviews)):
        ...
        value = p1.predict(y,p1.categories,predict_data_cat,p1.node)
    ...
    for x in range(0,len(predict_data_reviews)):
        ...
        value1 = p1.predict(y1,p1.categories,predict_data_cat,p1.node)
        value2 = p1.predict(y2,p1.categories,categories_for_both[0],p1.node)
