...
if(type_of_test == "test_examples"):
    ...
    with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_accur_pres_rec_f_Bayes",file_name),'a') as f:
    ...
    with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/ErrorTrain_ErrorTest_Bayes",file_name),'a') as f:
    ...
    with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/Accuracy_on_Training_data_Bayes",file_name),'a') as f:
