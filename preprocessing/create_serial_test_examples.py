from construct_serial_test_examples import training_data_frame
import numpy as np 
import os 
...
"""
file_path = os.path.join("C:/Users/Nikos/Documents/GitHub/Aiexercise2/per_keys_serial/",file_name)
if not os.path.exists("C:/Users/Nikos/Documents/GitHub/Aiexercise2/per_keys_serial/"):
    os.makedirs("C:/Users/Nikos/Documents/GitHub/Aiexercise2/per_keys_serial/")
"""
file_path = os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_test_serial/",file_name)
if not os.path.exists("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_test_serial/"):
    os.makedirs("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_test_serial/")
with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_test_serial/",file_name),"a") as f:
    for x in categories: 
        f.write(x + " ")
