from construct_random_training_examples import training_data_frame
import numpy as np 
import os 
...
with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys/",file_name),"a") as f:
    for x in categories: 
        f.write(x + " ")
