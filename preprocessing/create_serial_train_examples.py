from construct_serial_train_examples import training_data_frame
import numpy as np 
import os 
...
"""
file_path = os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_serial/",file_name)
if not os.path.exists("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_serial/"):
    os.makedirs("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_serial/")
with open(os.path.join("C:/Users/fotis/OneDrive/Desktop/exer/Aiexercise2/per_keys_serial/",file_name),"a") as f:
    for x in categories: 
        f.write(x + " ")
